...
class BinanceFutures(BinanceAPI):
    ...
    def set_leverage(self, symbol, leverage):
        ...
        return self.get_api().fapiprivate_post_leverage(
            {
